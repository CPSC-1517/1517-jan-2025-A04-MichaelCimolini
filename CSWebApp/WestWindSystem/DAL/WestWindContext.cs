...
internal partial class WestWindContext : DbContext
{
    ...
    /// <summary>
    /// The virtual keyword is there to tell us that, should we inherit this class, we can override these
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC07A465BC3E");
        ...
        {
            entity.HasKey(e => e.ManifestItemID).HasName("PK__Manifest__9000192CB5B1B030");
        ...
        {
            entity.HasKey(e => e.ShipmentID).HasName("PK__Shipment__5CAD378D42A4DC37");
